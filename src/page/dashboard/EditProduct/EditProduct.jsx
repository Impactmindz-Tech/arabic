...
const EditProduct = () => {
  ...
  return (
    <>
      <div className="pb-20">
      <Header />
        <BackButtonMenu text="تعديل المنتج" link="/dashboard/detail_my_product" />
        ...
        <form className="flex flex-col mt-6 gap-y-2" noValidate>
          <label
            className="font-bold 2xl:text-sm text-right  bg-white text-input-label -top-2 left-5 text-[11px] px-1"
         ...
         اسم المنتج
          ...
          <label
            className="2xl:text-sm font-bold text-right  bg-white text-input-label -top-2 left-5 text-[11px] px-1"
            htmlFor="category"
          >
       الفئة
          </label>
