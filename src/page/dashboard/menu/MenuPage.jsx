...
const MenuPage = () => {
  return (
    <>
      ...
      <p className="cursor-pointer text-[#525252] font-bold">
      القائمة 
      </p>
    ...
    بياناتى
        ...
        <div className="menus my-5 gap-y-5">
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.user} alt="user" /></div>
            </div>
          </div>
          ...
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.msg} alt="msg" /></div>
            </div>
          </div>
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            <div className="text-3xl"><img src={Images.leftarrow} alt={Images.leftarrow} /></div>
            ...
            <div className="icon"> <img src={Images.monitor} alt="monitor" /></div>
            </div>
          </div>
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            <div className="text-3xl"><img src={Images.leftarrow} alt={Images.leftarrow} /></div>
            ...
            <div className="icon"> <img src={Images.heart} alt="heart" /></div>
            </div>
          </div>
        ...
        <div className="menus my-5 gap-y-5">
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.callus} alt="callus" /></div>
            </div>
          </div>
          ...
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.info} alt="info" /></div>
            </div>
          </div>
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            <div className="text-3xl"><img src={Images.leftarrow} alt={Images.leftarrow} /></div>
            <div className="flex gap-3">
            <div className="font-medium text-[#545454]"> الشروط والأحكام   </div>
            <div className="icon"> <img src={Images.correct} alt="correct" /></div>
            </div>
          </div>
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            <div className="text-3xl"><img src={Images.leftarrow} alt={Images.leftarrow} /></div>
            ...
            <div className="icon"> <img src={Images.share} alt="share" /></div>
            </div>
          </div>
          ...
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.click} alt="click" /></div>
            </div>
          </div>
          ...
          <div className="flex w-full cursor-pointer border-b border-[#DADADA] justify-between py-5" >
            ...
            <div className="icon"> <img src={Images.logout} alt="logout" /></div>
            </div>
          </div>
